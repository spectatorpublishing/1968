...
<div className={classes.flexContainer} id="contentWrap2">
...
<div id="row41" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-1" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/GOXAAK4FJ5AKTLPEKBCNL2L2LU.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Bruce Bernstein, 1976 </div>

</div>


<div id="row42" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-2" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/77PTZ4DID5DOHOGTG672UBDFGA.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Arthur Schwartz, 1975 </div>

</div>
<div id="row43" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-3" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/JS6RQP7C2BE4NEUH3TFWMD3YGU.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Donna Futterman, 1975 </div>
</div>

    <div className={classes.row41}><b>Bruce Bernstein occupied the Statue of Liberty for anti-imperialism</b>
    <br></br>
    ...
    <div className={classes.row42}><b>Arthur Schwartz only went to 20 classes in his last two years at Columbia</b>
    <br></br>
    <i>by Trisha Mukherjee</i>
    <br></br>
    ...
    <div className={classes.row43}><b>While Donna Futterman took over buildings in the ’70s, she feared coming out at Barnard</b>
    <br></br>
    <i>by Trisha Mukherjee</i>
    <br></br>
...
<div id="row44" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-1" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/ESFAG3V5UVDOPJD7F6SLC7HBFA.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Mindy Ohringer, 1984 </div>

</div>


<div id="row45" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-2" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/2HJCBNGSHND2PNPP5R4S2WXKZE.jpg" style = {profilePicStyle}/>
    </div>
    <div className={classes.name}> Daniel Armstrong, 1984 </div>
</div>
<div id="row46" className={classes.button col-md-4 col-xs-4}>
    <div id= "profile-pic-3" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/KA27HIMEH5CKXNTKC3KZYB4U3M.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Robert Kahn, 1985 </div>
</div>

<div className={classes.row44}><b>Mindy Ohringer: A Revolutionary Digit</b>
    <br></br>
...
<div className={classes.row45}><b>Daniel Armstrong and his Flyers</b>
    <br></br>
...
<div id="row47" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-1" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/AMHWI6GYZVHRDLEFQ2JGQRFQLM.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Winston Grady-Willis, 1987 </div>

</div>


<div id="row48" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-2" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/5SPSJ4FJXJE73DGJXNU2OLULMY.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Warigia Bowman, 1990 </div>
</div>
<div id="row49" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-3" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/FYXFUR2FD5BCVATFDJGYC6BOB4.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Noah Potter, 1995 </div>

</div>

<div className={classes.row47}><b>Winston Grady-Willis’ Two Blockades of Hamilton Hall</b>
    <br></br>
    <i>by Parth Chhabra</i>
    <br></br>
...
<div className={classes.row48}><b>Warigia Bowman stays mindful of student voices
    </b>
    <br></br>
    <i>by Candy Chan</i>
    <br></br>
...
<div className={classes.row49}><b>Noah Potter unintentionally started a takeover of Low Library</b>
    <br></br>
    <i>by Candy Chan</i>
    <br></br>
...
<div id="row411" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-1" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/WOFB354KBJEX5A4EMOOZGTGIUY.png" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Jennifer Glaser, 1996 </div>

</div>


<div id="row412" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-2" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/SZ2CIRQYUBCN7FUYDMUVYYYNUM.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Isolde Raferty, 2004 </div>
</div>
<div id="row413" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-3" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/O6U4Z3VVENAKTNEKH7T5ZWTTEI.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Jessie Kindig, 2004 </div>
</div>

<div className={classes.row411}><b>Jennifer Glaser Worked within the System</b>
    <br></br>
    <i>by Lyric Bowditch</i>
    <br></br>
...
<div className={classes.row412}><b>Isolde Raftery and Journalism as Activism</b>
    <br></br>
...
<div className={classes.row413}><b>Jessie Kindig and Post-9/11 Anti-War Activism</b>
    <br></br>
    <i>by Alex Gluckman</i>
    <br></br>
...
<div id="row414" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-1" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/UEJRN44HQNBIDGACO6477FY44Y.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> David Johns, 2007 </div>
</div>


<div id="row415" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-2" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/A7F7QOLTDBD3HMXKLMJYSHKR24.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Karina Garcia, 2007 </div>

</div>
<div id="row416" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-3" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/WQJKUYHMTVEABPMSPF3QF3C2E4.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Bryan Mercer, 2007 </div>
</div>

<div className={classes.row414}><b>David Johns Finally Embraces His Educational Calling</b>
    <br></br>
    <i>by Jordan Allyn</i>
    <br></br>
...
<div className={classes.row415}><b>Karina Garcia Kicks Ass and Knocks Down Walls</b>
    <br></br>
    <i>by Jordan Allyn</i>
    <br></br>
...
<div className={classes.row416}><b>Bryan Mercer Never Stopped Organizing</b>
    <br></br>
    <i>by Jordan Allyn</i>
    <br></br>
...
<div id="row417" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-1" style= "border-style:solid; border-color:white; border-width:2px; display: inline-block;">
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/ZMYA6RMC2FA5TFN46JV6BQY7LE.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Victoria Ruiz, 2009 </div>

</div>


<div id="row418" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-2" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/HFVVVSZWJZDDLBX5XGCFBMBFWY.jpeg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Johanna Ocana, 2010 </div>
</div>
<div id="row419" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-3" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/EZ2XCJL3RRF2XEGESMP7NE3FIM.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Avi Edelman, 2011 </div>
</div>

<div className={classes.row417}><b>Victoria Ruiz Used To Be Fearless</b>
    <br></br>
    <i>by Jordan Allyn</i>
    <br></br>
...
<div className={classes.row418}><b>Johanna Ocana Does Not Let Fear Stop Her</b>
    <br></br>
    <i>by Jordan Allyn</i>
    <br></br>
...
<div className={classes.row419}><b>Avi Edelman: activist and administrator</b>
    <br></br>
    ...
    <div id="row421" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-1" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/RWDBMCUS5BG5BGOTBSA6IP3VHU.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Lauren Herold, 2012 </div>
    </div>


    <div id="row422" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-2" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/X2WDUZ34UJBTVPKCM7YHGUG6GU.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Cindy Gao, 2012 </div>
    </div>
    <div id="row423" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-3" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/BHUU3Y5IYVD6VJYXA2IZWGSPBM.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Maya Gaul, 2013 </div>

    </div>

    <div className={classes.row421}><b>Lauren Herold worked with and without the administration to create change</b>
    <br></br>
    <i>by Megan Evershed</i>
    <br></br>
    ...
    <div className={classes.row422}><b>Cindy Gao speaks up about speaking out</b>
    <br></br>
    <i>by Megan Evershed</i>
    <br></br>
    ...
    <div className={classes.row423}><b>Maya Gaul’s diverse experiences with activism</b>
    <br></br>
    <i>by Megan Evershed</i>
    <br></br>
    ...
    <div id="row424" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-1" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/CHWEBRUNL5BSBMTGQZOBOWMOEM.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Zoe Ridolfi-Starr, 2015 </div>
    </div>


    <div id="row425" className={classes.button col-md-4 col-xs-4}>
    <div id= "profile-pic-2" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/UBCDCNEYS5GLHH4V7V67HK43WU.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Iliana Salazar-Dodge, 2016 </div>
    </div>
    <div id="row426" className={classes.button col-md-4 col-xs-4}>
    <div id= "profile-pic-3" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/3SEYH4VZGFBXBOFCPWT4DETI5E.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Asha Rosa Ransby-Sporn, 2016 </div>

    </div>

    <div className={classes.row424}><b>Zoe Ridolfi-Starr Has Heard It All</b>
    <br></br>
    ...
    <div className={classes.row425}><b>Iliana Salazar-Dodge advocates for unconditional love in activism</b>
    <br></br>
    <i>by Megan Evershed</i>
    <br></br>
    ...
    <div className={classes.row426}><b>Asha Rosa Ransby-Sporn on How to Make Columbia Divest from Private Prisons</b>
    <br></br>
    <i>by Sophia Cornell</i>
    <br></br>
    ...
    <div id="row427" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-1" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/2QB3JK5H5ZDHTMOVJNV6BHHLHM.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Olga Brudastova, 2018 </div>
    </div>


    <div id="row428" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-2" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/7M4X5MQ3TBEGXFZTWHUOPGJ6AE.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Julia Crain, 2018 </div>
    </div>
    <div id="row429" className={[classes.button,classes.col-md-4,classes.col-xs-4].join(" ")}>
    <div id= "profile-pic-3" style = {profileDivStyle}>
    <img src="https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/PQOICXQTONDLDJLK5OKGUYWJVY.jpg" style = {profilePicStyle} />
    </div>
    <div className={classes.name}> Inga Manticas, 2020 </div>

    </div>

    <div className={classes.row427}><b>Olga Brudastova Wants to Sit At the Bargaining Table </b>
    <br></br>
    <i>by Sophia Cornell</i>
    <br></br>
    ...
    <div className={classes.row428}><b>Julia Crain Thinks Columbia’s Intersectionality Is Misapplied</b>
    <br></br>
        <i>by Sophia Cornell</i>
    <br></br>
    ...
    <div className={classes.row429}><b>Inga Manticas Parties with 1968 Protest Signs</b>
    <br></br>
    <i>by Sophia Cornell</i>
    <br></br>
    ...
    <div className= {classes.border} style={{marginTop: "2vw", marginBottom: "0"}}>
    </div>
    <div className = {classes.part3link}>
    <p>PART III: COLUMBIA AND HARLEM</p>
    </div>
